...
tools:
	sudo apt -y install htop meld guake keepassx retext vim geany glade ghex myrepos baobab byobu gnome-tweaks pv fortune cowsay lolcat screenfetch autokey-gtk shutter yubikey-personalization-gui flatpak-builder
